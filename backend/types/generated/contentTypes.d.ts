...
export interface ApiAgendaAgenda extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    mode: Schema.Attribute.Enumeration<['by-day', 'all-days']> &
      Schema.Attribute.DefaultTo<'by-day'>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPricePrice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Configurable price table for the event';
    displayName: 'Price';
    pluralName: 'prices';
    singularName: 'price';
  };
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    show_press_kit: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    show_prices: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
