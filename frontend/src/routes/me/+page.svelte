...
<div class="tab-content">
	...
	<div class="is-flex is-align-items-center">
		...
		<a href="/logout" data-sveltekit-reload class="button is-secondary">
			<span class="icon-text">
						...
						<div class="column">
							<div class="card">
								<div class="card-content">
									...
									<div class="field">
										<label class="label">Menú seleccionado</label>
										<div class="control">
							...
							<div class="columns is-5">
								<div class="column">
									<p>La <b>inscripción Premium</b> incluye la camiseta de la XXIX Mereth Aderthad, diseñada especialmente para conmemorar el Día de Los Portadores por nuestra compañera Gilwen.
										...
										Se han creado dos modelos: uno de corte recto y otro de corte entallado. </p>
									...
									<div class="column">
										<div class="card">
											<div class="card-content">
												...
												<p>Recuerda que las actividades son limitadas y que debes inscribirte a las que quieras asistir.</p>
												<ul class="list ml-0">
