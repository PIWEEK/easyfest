<script lang="ts">
	...
	const activitiesProposalFormUrl = 'https://forms.gle/7yNywaBJzLX15qzm9';
</script>

<section class="hero page-title">
	<h3 class="title">{data.title ?? 'Propuesta de actividades'}</h3>
</section>

<section class="section proposal-page">
	<div class="container">
		<div class="content content-border proposal-card">
			<figure class="proposal-visual">
				<img src={proposalImage} alt="Gandalf caminando entre la hierba" />
			...
			<div class="proposal-actions">
				<a
					...
					href={activitiesProposalFormUrl}
					target="_blank"
					rel="noreferrer"
				>
					¡ENVÍA TU PROPUESTA!
